...
class TestConfigDriver(unittest.TestCase, TestConfigNetworkDriver):
    ...
    def setUpClass(cls):
        ...
        username = 'vagrant'
        password = 'vagrant'
        cls.vendor = '{{cookiecutter.driver_name}}'

        optional_args = {'port': 12443, }
        cls.device = {{cookiecutter.driver_name}}.{{cookiecutter.driver_name | capitalize}}Driver(hostname, username, password, timeout=60,
